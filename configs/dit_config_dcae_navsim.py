...
datasets_paths=dict(
    ...
    openscene_root= '/inspire/hdd/project/roboticsystem2/public/OpenScene/openscene-v1.1',  # NavSim dataset path
)
train_data_list=['navsim']  # Use navsim dataset (OpenScene data)
...
patch_size=1
vae='DCAE_f32c32'
vae_ckpt='/inspire/hdd/project/roboticsystem2/jingzhanghui-253108140204/world_model/RL/Epona/checkpoints/Epona/dcae_td_20000.pkl' #! VAE checkpoint path
