...
def pdm_score(
    ...
    print(f"PDM Score: {score}")
    print(f"No At Fault Collisions: {no_at_fault_collisions}")
    print(f"Drivable Area Compliance: {drivable_area_compliance}")
    print(f"Ego Progress: {ego_progress}")
    print(f"Time To Collision Within Bound: {time_to_collision_within_bound}")
    print(f"Comfort: {comfort}")
    print(f"Driving Direction Compliance: {driving_direction_compliance}")
    return PDMResults(
