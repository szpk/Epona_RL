...
def main(args):
    ...
    test_dataset = NuPlan('/inspire/hdd/project/roboticsystem2/public/nuplan', '/inspire/hdd/project/roboticsystem2/public/epona', split='test', condition_frames=args.condition_frames+args.test_video_frames+args.traj_len, downsample_fps=args.downsample_fps, h=args.image_size[0], w=args.image_size[1])
