...
# Note: trms2d is mapped to LayerNorm2d instead of TritonRMSNorm2d to avoid Triton compatibility issues
REGISTERED_NORM_DICT: dict[str, type] = {
    "bn2d": nn.BatchNorm2d,
    "ln": nn.LayerNorm,
    "ln2d": LayerNorm2d,
    "trms2d": LayerNorm2d,  # Changed from TritonRMSNorm2d to LayerNorm2d to avoid Triton CUDA errors
}
